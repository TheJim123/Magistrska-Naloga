...
\kljucnebesede{Linearna algebra, funkcionalna analiza, Hilbertov prostor, omejen linearen operator, spekter, spektralni radij, normalen operator, unitaren operator, sebiadjungiran operator} % navedite nekaj ključnih pojmov, ki nastopajo v delu
